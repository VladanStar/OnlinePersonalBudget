...
class Register extends React.Component {
    ...
    submitCredentials = () => {
        ...
        axios
            .post(`https://budgetapp.digitalcube.rs/api/tenants/77bd5a17-d27d-45b3-88fe-4cd8384a297e/users`, payload
            )
            .then((response) => {
            ...
            <div className="wrapLogin">
                ...
                <div className="inputWrapp">
                    ...
                    <div className="passwordInput">
                        ...
                        />
                        <div className="eyeIconn" onClick={this.changeClass}>
                ...
                <div className="register">
                    <h6>Already have account? <Link to="/">Log in</Link></h6>
                </div>
            </div>
        );
    }
